...
Messages.user_cert_missing = "No se ha encontrado un certificado " \
    "personal"
Config.instname = "Universidad Rey Juan Carlos"
Config.profilename = "Universidad Rey Juan Carlos"
Config.url = "https://eduroam.urjc.es/"
Config.email = "tu soporte local eduroam®"
Config.title = "eduroam CAT"
Config.server_match = "urjc.es"
...
Config.user_realm = "urjc.es"
Config.ssids = ['eduroam']
Config.del_ssids = ['wireless_urjc']
Config.servers = ['DNS:europa.urjc.es', 'DNS:ganimedes.urjc.es', 'DNS:radius.urjc.es']
Config.use_other_tls_id = False
Config.anonymous_identity = "20220719anonymous@urjc.es"
Config.tou = ""
